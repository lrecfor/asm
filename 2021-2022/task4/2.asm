...
htoi: ; в регистре bx - адрес строки c числом, в регистре si - длина числа, функция возвращает в регистре di полученное число	
	xor ax, ax
...
itoh: ; в регистре ax - число, в регистре bx - адрес строки для числа, в регистре si - адрес длины строки для числа, в di - количество разрядов	
	dec di
